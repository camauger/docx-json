#!/usr/bin/env python
"""
Convertit un fichier DOCX en Markdown en utilisant pypandoc.
Usage: python docx_to_md.py <fichier_docx> [<fichier_md>]
"""
...
def docx_to_md(input_file, output_file=None):
    ...
    Args:
        input_file (str): Chemin vers le fichier DOCX d'entrée
        output_file (str, optional): Chemin vers le fichier Markdown de sortie. Si None,
                                    remplace l'extension .docx par .md
...
if __name__ == "__main__":
    # Afficher un en-tête
    print("\n" + "=" * 60)
    print(" CONVERTISSEUR DOCX VERS MARKDOWN ".center(60, "="))
    print("=" * 60 + "\n")

    # Vérifier les arguments
    if len(sys.argv) < 2:
        print(f"Usage: {sys.argv[0]} <fichier_docx> [<fichier_md>]")
        sys.exit(1)
    ...
    try:
        result = docx_to_md(input_file, output_file)
...
# usage: python docx_to_md.py "C:\Users\Administrateur\Desktop\test.docx" "C:\Users\Administrateur\Desktop\test.md"